...
const userSchema = new Schema({
    ...
    email: { type: String, required: true, unique: true, minLength: 3, maxLength: 60, trim: true, match: /.+@.+\..+/ },
    password: { type: String, required: true, minLength: 8, maxLength: 200, trim: true, match: /^(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{8,}$/ },
    avatar: { type: String, required: true, enum: [ "1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png", "8.png", "9.png" ] },
